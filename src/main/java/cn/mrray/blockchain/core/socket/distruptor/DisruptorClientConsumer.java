...
import cn.mrray.blockchain.core.socket.handler.client.FetchBlockResponseHandler;
import cn.mrray.blockchain.core.socket.handler.client.VoteLeaderHandler;
...
public class DisruptorClientConsumer implements MessageConsumer {
    ...
    static {
        ...
        handlerMap.put(PacketType.VOTE_LEADER, new VoteLeaderHandler());
    }
